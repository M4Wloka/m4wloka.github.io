...
const projects = [
  {
    ...
    image: "/public/csv-handler-jpg.jpg",
    video: '/public/csv-handler-video.mp4',
    description: 'This project involves the development of a Python program utilizing CSV file handling, data visualization with Matplotlib, and Object-Oriented Programming (OOP) principles. The goal is to create a robust solution adhering to the latest Python standards.',
    links: {
      github: 'https://github.com/M4Wloka/Problem-Solving-through-Programming-QHO426',
    },
    progress: 'Completed'
  },
  {
...
const categories = ['All Projects', 'App Development', 'Web Development'];

let selectedCategory = 'All Projects';
